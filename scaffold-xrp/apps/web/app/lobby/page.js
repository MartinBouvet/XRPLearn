...
export default function Lobby() {
    ...
    return (
        <main className="min-h-screen flex flex-col items-center p-8 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white relative transition-colors duration-300">
            {isMock && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12 w-full max-w-4xl">
                ...
                {players.map((player, index) => (
                    <div
                        key={index}
                        className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full py-3 px-6 text-center animate-bounce shadow-md dark:shadow-none"
